folder_path = 'P:\prec\VOCtest_06-Nov-2007\VOCdevkit\VOC2007\Annotations';
objcount = 1;
...
for i = 1:numFiles
    ...
    imgpath = strcat('P:\prec\VOCtest_06-Nov-2007\VOCdevkit\VOC2007\JPEGImages\', annotation.annotation.filename.Text );
    ...
    for j = 1:numObjects
        ...
        c = sscanf(boundingBox.ymax.Text, '%d');
